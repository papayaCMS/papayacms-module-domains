...
* @version $Id: actbox_domain_richtext.php 39499 2014-03-04 10:15:30Z weinert $
*/
...
* @subpackage Free-Domains
*/
class actionbox_domain_richtext extends base_actionbox {
  ...
  */
  var $editFields = array(
    ...
    'text' => array('Default text', 'isXhtml', FALSE, 'richtext', 30)
  );
  ...
  */
  function getParsedData() {
    if (!empty($this->data['field_identifer'])) {
      $domainConnector = $this->papaya()->plugins->get(
